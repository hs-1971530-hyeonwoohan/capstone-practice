package com.passionroad.passionroad.util;
...
public class JWTUtil {
    ...
    @Value("${com.passionroad.jwt.secret}")  // application.properties 설정파일에서 지정한 값이 클래스 필드에 자동으로 할당된다
    private String key;                 // passionroad2023
