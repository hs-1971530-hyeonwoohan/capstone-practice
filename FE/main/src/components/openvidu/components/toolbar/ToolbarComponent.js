                ...
                <Toolbar className="toolbar">
                    ...
                    <div className="buttonsContent">
                        <IconButton
                            ...
                            size="large">
                            {localUser !== undefined && localUser.isAudioActive() ? <Mic /> : <MicOff style={{color:'red'}} />}
                        </IconButton>
                        ...
                        {localUser !== undefined &&
                            localUser.isScreenShareActive() && (
                                <IconButton onClick={this.stopScreenShare} id="navScreenButton" size="large">
                        ...
                        <IconButton
                         ...
                         <IconButton color="inherit" onClick={this.toggleChat} id="navChatButton" size="large">
