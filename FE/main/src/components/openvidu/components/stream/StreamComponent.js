...
export default class StreamComponent extends Component {
    ...
    render() {
        return (
            <div className="OT_widget-container" style={{borderRadius:'6px'}}>
                <div className="pointer nickname">
                    {this.state.showForm ? (
                        ...
                        <div onClick={this.toggleNicknameForm}>
                            ...
                            {this.props.user.isLocal() && <span id=""> (변경)</span>}
                        </div>
                    )}
                </div>
                    ...
                    <div className="streamComponent">
                        ...
                        <div>
                            {!this.props.user.isLocal() && (
                                <IconButton id="volumeButton" onClick={this.toggleSound} size="large">
