...
function LoginForm() {
  ...
  return (
    <div>
      {/*여기를 Loginform 컴포넌트로*/}
      <div className="bg-white shadow rounded w-full px-12 py-8">
        <p
          tabindex="0"
        ...
        <form noValidate onSubmit={handleSubmt}>
          <label
            id="userId"
          ...
          <button
            type="submit"
            role="button"
            className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full mt-8"
          >
            Sign In
          </button>
        </form>
